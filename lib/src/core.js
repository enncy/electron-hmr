...
var ElectronHmr = /** @class */ (function () {
    ...
    ElectronHmr.prototype.watch = function (options) {
        var _this = this;
        chokidar_1.watch((options === null || options === void 0 ? void 0 : options.paths) || '.', options === null || options === void 0 ? void 0 : options.watchOptions).on('change', function (path, stats) {
            if (stats === null || stats === void 0 ? void 0 : stats.isFile) {
                _this.update(path);
            }
            options === null || options === void 0 ? void 0 : options.change(path, stats);
        });
    };
    /**
